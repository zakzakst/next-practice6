...
index 33511b1..0a59b0b 100644
--- a/tasks/develop-diff/diff.md
...
```diff
diff --git a/tasks/develop-diff/index.ts b/tasks/develop-diff/index.ts
++index 307b7c3..0654b17 100644
++--- a/tasks/develop-diff/index.ts
+++++ b/tasks/develop-diff/index.ts
++@@ -1 +1,65 @@
...
++index 4cb61a3..0000000
++--- a/tasks/simple-git.ts
+++++ /dev/null
++@@ -1,78 +0,0 @@
++-import simpleGit from "simple-git";
++-import fs from "fs";
...
### tasks/simple-git/index.ts
```diff
diff --git a/tasks/old/simple-git1.ts b/tasks/simple-git/index.ts
++similarity index 100%
++rename from tasks/old/simple-git1.ts
++rename to tasks/simple-git/index.ts
+ 
+ ```
+
+```
